...
int main()
{
    ...
    auto [begin, end] = numbers.equal_range(
        5 ); // equal_range() is a function which is used to get the range of elements with the same key
    ...
    std::cout << '\n';
    numbers.erase( 5 );
    std::multiset<std::string, std::greater<>> words = { "apple", "banana", "cherry", "apple" };
